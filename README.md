...
* [Data Mangement](#data-mangement)
    ...
    * [transaction](#transaction)
      * [reducers(combined reducers)](#reducerscombined-reducers)
      * [actions(separated by each of the reducer that was combined)](#actionsseparated-by-each-of-the-reducer-that-was-combined)
      * [selectors(separated by each of the reducer that was combined)](#selectorsseparated-by-each-of-the-reducer-that-was-combined)
